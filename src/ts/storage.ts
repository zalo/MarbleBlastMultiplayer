...
const DEFAULT_STORAGE_DATA: StorageData = {
	settings: {
		...
		inputType: 0,
		frameRateCap: 7,
		canvasDesynchronized: !/(CrOS|Windows)/.test(navigator.userAgent), // Turn it off on ChromeOS and Windows (some GPUs/drivers cause flickering with desynchronized canvas)
